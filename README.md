...
| 구분 | 이름 | 학과/학년 | 주요 담당 업무 | 연락처 |
|------|------|-----------|----------------|---------|
| 팀장 | 박주호 | 소프트웨어융합과/3학년 | 백엔드 개발 / DB 설계 | pjhjh2350@gmail.com |
| **팀원** | **신태빈** | 소프트웨어융합과/3학년 | **서버 보안 / 시스템 관리** | luckking101@naver.com |
| 팀원 | 박진성 | 소프트웨어융합과/3학년 | 프론트엔드 / UI·UX | jincastle0220@kbu.ac.kr |
